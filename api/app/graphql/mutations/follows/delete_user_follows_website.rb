  ...
  module Follows
    ...
    class DeleteUserFollowsWebsite < BaseMutation
      ...
      def resolve(website_id:)
        ...
        userFollowsWebsite = ::UserFollowsWebsite.find_by(user_id: user.id, website_id: website_id)

        if userFollowsWebsite
          userFollowsWebsite.destroy!
          raise GraphQL::ExecutionError, userFollowsWebsite.errors.full_messages.join(", ") unless userFollowsWebsite.errors.empty?
